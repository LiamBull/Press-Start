...
<div id="demo3" class="row"></div>

<div id="demo4" class="row"></div>
...
for (var i = 0; i < 4; i++) {
	// $('#row').appendChild(item_card_creation());
	document.getElementById("demo3").appendChild(item_card_creation(jsonObj));
}

for (var i = 0; i < 4; i++) {
	// $('#row').appendChild(item_card_creation());
	document.getElementById("demo4").appendChild(item_card_creation(jsonObj2));
}
</script>
